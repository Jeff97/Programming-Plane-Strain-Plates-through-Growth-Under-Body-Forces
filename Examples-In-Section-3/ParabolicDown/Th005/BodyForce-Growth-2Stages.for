...
! 1. f[L]=0 Nsolve from the epsilon order equation
        f1 = -8.400260358186198 + 17.352916698208027*X - 
     &   8.737365844191682*X**2 - 1.4318948588230915*X**3 +
     &   1.8291222249564265*X**4 - 6.245539723601765*X**5 +
     &   43.38557759631839*X**6 - 152.00928958204142*X**7 +
     &   170.88809690420672*X**8 + 848.6145312034602*X**9 -
     &   4488.0981566940345*X**10 + 9519.904702291338*X**11 -
     &   8505.134220429789*X**12 - 2961.051346230052*X**13 +
     &   10815.40559922674*X**14 + 397.89309270275646*X**15 -
     &   11393.334676576604*X**16 - 1810.5269880219514*X**17 +
     &   11422.178235741792*X**18 + 5883.6648458888285*X**19 -
     &   9419.010486381592*X**20 - 10685.5037182321*X**21 +
     &   4468.037407312998*X**22 + 13727.698878203202*X**23 +
     &   2223.112969055085*X**24 - 13964.665268567693*X**25 -
     &   8030.122678820822*X**26 + 13912.78483898617*X**27 +
     &   10183.10218444417*X**28 - 21467.336205044176*X**29 +
     &   11326.646284197888*X**30 - 2060.891187333616*X**31
        ...
        Lambda1z1St2 = (Epsilon*(L - X)*X*(1 + X**2) + 
     &  h*(8*L - Epsilon*Sqrt(1 + X**2)) - 
     &  8*Epsilon*f1*L*(-h + (1 + X**2)**1.5))/
     &  (8.*h*L*(1 + X**2))
...
! =================================================================
        ...
        Lambda1z1St1 = (Epsilon*(L - X)*X*(1 + X**2) + 
     &  h*(8*L - Epsilon*Sqrt(1 + X**2)) - 
     &  8*Epsilon*f1*L*(-h + (1 + X**2)**1.5))/
     &  (8.*h*L*(1 + X**2))
