...
! TODO: one should modify the number of elements according to the mesh
      Parameter (NElem=3060, NGauss=27)
...
! 1. f[L]=0 Nsolve from the epsilon order equation
        f1 = -0.057248550506807036 - 1548.0145751380855*X + 
     &   1053.877011995243*X**2 + 4714.473759652506*X**3 + 
     &    2759.5680968283273*X**4 - 4773.316015925695*X**5 - 
     &    8855.177437239221*X**6 + 113.51657356708763*X**7 + 
     &    11686.987779816594*X**8 - 5151.857933096906*X**9 + 
     &    363.9262289046866*Sin(2*Pi*X) - 
     &    96.32363567180033*Sin(4*Pi*X) + 
     &    29.937748378643104*Sin(6*Pi*X) - 
     &    3.452593288307365*Sin(8*Pi*X) - 
     &    0.028785629601620857*Sin(12*Pi*X) - 
     &    0.0019850677173098093*Sin(16*Pi*X) - 
     &    0.0002832353013679367*Sin(20*Pi*X) - 
     &    0.00006219334700553046*Sin(24*Pi*X) - 
     &    0.000018024047451135705*Sin(28*Pi*X) - 
     &    6.283627122896719e-6*Sin(32*Pi*X) - 
     &    1.9484241545491107e-6*Sin(36*Pi*X) - 
     &    5.515432435802692e-7*Sin(40*Pi*X) + 
     &    X*(-671.4840686712677*Sin(2*Pi*X) + 
     &    381.7412995964048*Sin(4*Pi*X) - 
     &       97.0217995572978*Sin(6*Pi*X) + 
     &       6.131067576704383*Sin(8*Pi*X) + 
     &       0.09050382028334186*Sin(12*Pi*X) + 
     &       0.006907116330945418*Sin(16*Pi*X) + 
     &       0.0009822449308500882*Sin(20*Pi*X) + 
     &       0.00020112415599494754*Sin(24*Pi*X) + 
     &       0.000051810599631377606*Sin(28*Pi*X) + 
     &       0.000016460326098383988*Sin(32*Pi*X) + 
     &       4.1483636355719966e-6*Sin(36*Pi*X) + 
     &       1.268086647011933e-6*Sin(40*Pi*X) - 
     &       9.485744019697267e-7*Sin(44*Pi*X)) + 
     &       X**2*(951.9091808272725*Sin(2*Pi*X) - 
     &    380.36180245136956*Sin(4*Pi*X) + 
     &       97.05710329650785*Sin(6*Pi*X) - 
     &       6.128669553380979*Sin(8*Pi*X) - 
     &       0.09048789598454206*Sin(12*Pi*X) - 
     &       0.006823415190092505*Sin(16*Pi*X) - 
     &       0.0009161226270345907*Sin(20*Pi*X) - 
     &       0.00016492586783000616*Sin(24*Pi*X) - 
     &       0.000033669426236767844*Sin(28*Pi*X) - 
     &       8.064563350318183e-6*Sin(32*Pi*X) - 
     &       7.390737892849913e-7*Sin(36*Pi*X) - 
     &       3.0966148401161464e-7*Sin(40*Pi*X) + 
     &       4.4380180522167056e-7*Sin(44*Pi*X)) + 
     &       3.4322778146421295e-7*Sin(44*Pi*X)
