...
! TODO: one should modify the number of elements according to the mesh
      Parameter (NElem=3000, NGauss=27)
...
C
     ...
     &  Lambda1z2, EMOD, ENU, C10, D1, f1, Df1, DDf1, L,
     &  LambdaDX, LambdaDXDX,
     &  Lambda1z0St1, Lambda1z0St2, Lambda1z1St1, Lambda1z1St2, 
     &  G11St1, G11St2
...
C ELASTIC PROPERTIES
        ...
        C0 = PROPS(1)! Pa
        h = 0.025 ! m (total thickness = 2h)
        L = 1.0 ! length of the beam
        Epsilon = (RhoR*fZ)*L/(C0) ! 0.0001
...
! 1. f[L]=0 Nsolve from the epsilon order equation
        f1 = -0.030607909109966473 - 1015.2116829493987*X + 
     &   720.8467209356734*X**2 + 3028.31433624277*X**3 + 
     &    1779.8423164354836*X**4 - 3076.2133619607157*X**5 - 
     &    5706.42742392365*X**6 + 56.92747546235136*X**7 + 
     &    7505.970960039006*X**8 - 3294.018730131547*X**9 + 
     &    207.3186545490856*Sin(2*Pi*X) - 
     &    33.12746744795037*Sin(4*Pi*X) + 
     &    8.508281164704464*Sin(6*Pi*X) - 
     &    0.8840846396793888*Sin(8*Pi*X) - 
     &    0.006586134399779339*Sin(12*Pi*X) - 
     &    0.00045303608537628436*Sin(16*Pi*X) - 
     &    0.00006566869695201563*Sin(20*Pi*X) - 
     &    0.000014497804037501873*Sin(24*Pi*X) - 
     &    3.922921175758853e-6*Sin(28*Pi*X) - 
     &    1.1785107943641926e-6*Sin(32*Pi*X) - 
     &    4.1169751288337615e-7*Sin(36*Pi*X) + 
     &    8.160217534777612e-8*Sin(40*Pi*X) + 
     &    X*(-295.4834105264248*Sin(2*Pi*X) + 
     &    123.47002993663162*Sin(4*Pi*X) - 
     &       26.389195423614083*Sin(6*Pi*X) + 
     &       1.5375546047708555*Sin(8*Pi*X) + 
     &       0.020572318967534378*Sin(12*Pi*X) + 
     &       0.0015779038951902252*Sin(16*Pi*X) + 
     &       0.00023159490262368576*Sin(20*Pi*X) + 
     &       0.000049908511842195605*Sin(24*Pi*X) + 
     &       0.00001275248783315054*Sin(28*Pi*X) + 
     &       3.706423931906914e-6*Sin(32*Pi*X) + 
     &       1.5291926640541665e-6*Sin(36*Pi*X) - 
     &       4.159574598848735e-7*Sin(40*Pi*X) - 
     &       2.62614682742668e-7*Sin(44*Pi*X)) + 
     &       X**2*(480.26637129008986*Sin(2*Pi*X) - 
     &    123.14337185274523*Sin(4*Pi*X) + 
     &       26.364711774009194*Sin(6*Pi*X) - 
     &       1.5379160124903637*Sin(8*Pi*X) - 
     &       0.020604266956163134*Sin(12*Pi*X) - 
     &       0.0015577703610183385*Sin(16*Pi*X) - 
     &       0.000219729453367142*Sin(20*Pi*X) - 
     &       0.00004440003973778144*Sin(24*Pi*X) - 
     &       0.00001042165650038855*Sin(28*Pi*X) - 
     &       2.9828587405895757e-6*Sin(32*Pi*X) - 
     &       1.3372724210864208e-6*Sin(36*Pi*X) + 
     &       2.9841198207572133e-7*Sin(40*Pi*X) - 
     &       1.583873978144531e-8*Sin(44*Pi*X)) + 
     &       1.3008057226141702e-7*Sin(44*Pi*X)

        Df1 = 0.0

        DDf1 = 0.0

        Lambda1z0St2 = (3*(1 + Epsilon*f1)*Sqrt(1 + 16*Pi**2*X**4))/5.
        Lambda2z0 = 1.0
        LambdaSz0 = 0.0

        ! =====================================

        Lambda1z1St2 = (-480*h*L*Pi*X*Sqrt(1 + 16*Pi**2*X**4) - 
     &   2560*h*L*Pi**3*X**5*Sqrt(1 + 16*Pi**2*X**4) - 
     &   8*Epsilon*f1*L*(3 + 96*Pi**2*X**4 + 768*Pi**4*X**8 + 
     &   60*h*Pi*X*Sqrt(1 + 16*Pi**2*X**4) + 
     &      320*h*Pi**3*X**5*Sqrt(1 + 16*Pi**2*X**4)) + 
     &      Epsilon*(1 + 16*Pi**2*X**4)*
     &   (-5*h + 12*Pi*X**2*(-L + X)*Sqrt(1 + 16*Pi**2*X**4))*
     &    Cos(2*Pi*X**2) + 20*Epsilon*h*Pi*X**2*Sin(2*Pi*X**2) + 
     &    320*Epsilon*h*Pi**3*X**6*Sin(2*Pi*X**2) - 
     &   3*Epsilon*L*Sqrt(1 + 16*Pi**2*X**4)*Sin(2*Pi*X**2) + 
     &   3*Epsilon*X*Sqrt(1 + 16*Pi**2*X**4)*Sin(2*Pi*X**2) - 
     &   48*Epsilon*L*Pi**2*X**4*Sqrt(1 + 16*Pi**2*X**4)*
     &   Sin(2*Pi*X**2) + 48*Epsilon*Pi**2*X**5*
     &    Sqrt(1 + 16*Pi**2*X**4)*Sin(2*Pi*X**2))/
     &    (40.*h*L*(1 + 16*Pi**2*X**4)**1.5)
...
! =================================================================
        ...
        Lambda1z0St1 = (3*(1 + Epsilon*f1)*Sqrt(1 + 16*Pi**2*X**4))/5.

        Lambda1z1St1 = (-480*h*L*Pi*X*Sqrt(1 + 16*Pi**2*X**4) - 
     &   2560*h*L*Pi**3*X**5*Sqrt(1 + 16*Pi**2*X**4) - 
     &   8*Epsilon*f1*L*(3 + 96*Pi**2*X**4 + 768*Pi**4*X**8 + 
     &   60*h*Pi*X*Sqrt(1 + 16*Pi**2*X**4) + 
     &      320*h*Pi**3*X**5*Sqrt(1 + 16*Pi**2*X**4)) + 
...
C G is growth tensor
        ...
        STATEV(5) = Lambda1z0St2
        STATEV(6) = Lambda1z1St2
        STATEV(7) = Lambda1z2
        STATEV(8) = G11
