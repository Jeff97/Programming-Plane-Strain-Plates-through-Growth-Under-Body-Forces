...
! TODO: one should modify the number of elements according to the mesh
      Parameter (NElem=3336, NGauss=27)
...
! 1. f[L]=0 Nsolve from the epsilon order equation
        f1 = 0.14690622468010167 - 1461.6948826330276*X + 
     &   1118.1802713507873*X**2 + 4192.128165317956*X**3 + 
     &    2492.3431685397645*X**4 - 4259.493997726294*X**5 - 
     &    7929.526752600572*X**6 - 10.29601809507116*X**7 + 
     &    10296.722203147445*X**8 - 4438.509049496835*X**9 + 
     &    217.17400406877766*Sin(2*Pi*X) + 
     &    32.71469361945416*Sin(4*Pi*X) - 
     &    17.669018421871492*Sin(6*Pi*X) + 
     &    2.502723874088026*Sin(8*Pi*X) + 
     &    0.027588673030822245*Sin(12*Pi*X) + 
     &    0.0023282098723696617*Sin(16*Pi*X) + 
     &    0.0003667654119930139*Sin(20*Pi*X) + 
     &    0.00008759264528390903*Sin(24*Pi*X) + 
     &    0.000026397718448791133*Sin(28*Pi*X) + 
     &    0.000011238569453324992*Sin(32*Pi*X) + 
     &    5.634849567881802e-6*Sin(36*Pi*X) + 
     &    2.8219084849824666e-6*Sin(40*Pi*X) + 
     &    X*(-33.12773351279682*Sin(2*Pi*X) - 
     &    161.41680520016502*Sin(4*Pi*X) + 
     &       62.556190885828634*Sin(6*Pi*X) - 
     &       4.62689103717221*Sin(8*Pi*X) - 
     &       0.08986778829831484*Sin(12*Pi*X) - 
     &       0.008434290872397674*Sin(16*Pi*X) - 
     &       0.00142473389852658*Sin(20*Pi*X) - 
     &       0.00034509956281592654*Sin(24*Pi*X) - 
     &       0.00009949718113107864*Sin(28*Pi*X) - 
     &       0.00004118738114238908*Sin(32*Pi*X) - 
     &       0.000018378815114412733*Sin(36*Pi*X) - 
     &       6.064304724664783e-6*Sin(40*Pi*X) - 
     &       6.744185389700803e-6*Sin(44*Pi*X)) + 
     &       X**2*(309.96351990732035*Sin(2*Pi*X) + 
     &    158.24111150793524*Sin(4*Pi*X) - 
     &       62.901389144655354*Sin(6*Pi*X) + 
     &       4.60773482483752*Sin(8*Pi*X) + 
     &       0.08993935487440345*Sin(12*Pi*X) + 
     &       0.008554720019101177*Sin(16*Pi*X) + 
     &       0.0014840797262287001*Sin(20*Pi*X) + 
     &       0.0003560258512801407*Sin(24*Pi*X) + 
     &       0.00009810704626384295*Sin(28*Pi*X) + 
     &       0.00003715459551986846*Sin(32*Pi*X) + 
     &       0.000013351712049758241*Sin(36*Pi*X) + 
     &       1.7162098977470915e-6*Sin(40*Pi*X) + 
     &       2.7831912025427067e-6*Sin(44*Pi*X)) + 
     &       2.614889826893319e-6*Sin(44*Pi*X)
