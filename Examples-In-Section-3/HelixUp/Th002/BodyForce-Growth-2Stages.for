...
! 1. f[L]=0 Nsolve from the epsilon order equation
        f1 = 0.06432967734768888 - 870.3728952677413*X + 
     &   647.8220871944891*X**2 + 2531.8721881290307*X**3 + 
     &    1500.8243856457236*X**4 - 2566.4578869911725*X**5 - 
     &    4777.492723717716*X**6 + 5.729222022312072*X**7 + 
     &    6222.133024482269*X**8 - 2694.1217248603143*X**9 + 
     &    147.1214123385323*Sin(2*Pi*X) + 
     &    2.2586347331420726*Sin(4*Pi*X) - 
     &    4.086381721555856*Sin(6*Pi*X) + 
     &    0.6671945455389813*Sin(8*Pi*X) + 
     &    0.008159194439334341*Sin(12*Pi*X) + 
     &    0.0007011985829148403*Sin(16*Pi*X) + 
     &    0.00011455349934594769*Sin(20*Pi*X) + 
     &    0.000028187169023414906*Sin(24*Pi*X) + 
     &    0.000010086387404746144*Sin(28*Pi*X) + 
     &    3.8019047483079793e-6*Sin(32*Pi*X) + 
     &    2.7026494317808357e-6*Sin(36*Pi*X) + 
     &    1.2570623503967788e-6*Sin(40*Pi*X) + 
     &    X*(-105.12520679418529*Sin(2*Pi*X) - 
     &    23.575450721836045*Sin(4*Pi*X) + 
     &       15.546538778725504*Sin(6*Pi*X) - 
     &       1.2552010570496503*Sin(8*Pi*X) - 
     &       0.02675214147827746*Sin(12*Pi*X) - 
     &       0.0025545678821979403*Sin(16*Pi*X) - 
     &       0.00044773445327524615*Sin(20*Pi*X) - 
     &       0.00010898337549640911*Sin(24*Pi*X) - 
     &       0.00003839922460724645*Sin(28*Pi*X) - 
     &       0.000011879685835438431*Sin(32*Pi*X) - 
     &       9.293539841621184e-6*Sin(36*Pi*X) - 
     &       2.939338728184075e-6*Sin(40*Pi*X) - 
     &       4.058615571517033e-6*Sin(44*Pi*X)) + 
     &       X**2*(269.09369619331324*Sin(2*Pi*X) + 
     &    22.24055271382514*Sin(4*Pi*X) - 
     &       15.707167696766122*Sin(6*Pi*X) + 
     &       1.2473158003836904*Sin(8*Pi*X) + 
     &       0.026712186166891423*Sin(12*Pi*X) + 
     &       0.0026019549602088006*Sin(16*Pi*X) + 
     &       0.00046826318093519924*Sin(20*Pi*X) + 
     &       0.00011118031711649024*Sin(24*Pi*X) + 
     &       0.000036693037446142876*Sin(28*Pi*X) + 
     &       9.285864819186431e-6*Sin(32*Pi*X) + 
     &       6.698370510111505e-6*Sin(36*Pi*X) + 
     &       7.433824062397186e-7*Sin(40*Pi*X) + 
     &       2.187577642536174e-6*Sin(44*Pi*X)) + 
     &       1.2541340779910066e-6*Sin(44*Pi*X)
